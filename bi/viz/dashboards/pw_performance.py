...
app = DjangoDash(name='pw_performance', external_stylesheets=[dbc.themes.BOOTSTRAP])
...
def graph_project_distribution(df):
    ...
    by_projects_graph.update_layout(uniformtext_minsize=11, uniformtext_mode='hide',
                                    showlegend=True, legend_title_text="Project",
...
def graph_countries_distribution(df):
    ...
    graph_countries_distribution = px.choropleth(
        ...
        color_continuous_scale=[(0.0, "#e6e7e7"), (0.0001, "#dde3e6"),
                                (0.0001, "#d3e1e8"), (0.0075, "#d1e4ed"),
                                (0.0075, "#c5e2f0"), (0.01, "#b1def3"),
                                (0.01, "#82d1f6"), (0.025, "#5ecafc"),
                                (0.025, "#24b8fc"), (0.05, "#0493d4"),
                                (0.05, "#04608a"), (1, "#01334a")
                                ]
    )
...
filters = dbc.Card(
    [
        html.H4("Filters", style={'margin-bottom': '1rem'}),
        dbc.Row([
